...
class Trainer(object):
    ...
    def train(self):
        ...
        np.savetxt('./{}_time_dim={}_embed_dim={}_train_time.csv'.format(self.args.dataset,self.args.time_dim,self.args.embed_dim),
                   np.array([np.array(train_loss), np.array(vaild_loss), np.array(test_loss)]).T,
                   delimiter=",")
